...
export default function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Show black navbar if there's any scroll
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <Link href="/" className="text-2xl font-bold text-white">
            <Image src={'/logo.png'} alt="logo" width={34} height={45} className="object-contain" />
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/pages" className="text-white hover:text-gray-300 transition-colors">
              PAGES
            </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link href="https://twitter.com" className="text-white hover:text-gray-300 transition-colors">
